...
import tn.esprit.nebulagaming.Detailpostforum
...
) : RecyclerView.Adapter<FroumAdapter.ViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.listpostforum, parent, false)
...
toPass.putInt("idPost", post.idPost)
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(context, Detailpostforum::class.java)
